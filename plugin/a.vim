...
call <SID>AddAlternateExtensionMapping('h',"c,cpp,cxx,cc,CC,mm,m")
call <SID>AddAlternateExtensionMapping('H',"C,CPP,CXX,CC,MM,M")
call <SID>AddAlternateExtensionMapping('hpp',"cpp,c,cxx,cc,mm,m")
call <SID>AddAlternateExtensionMapping('HPP',"CPP,C,CXX,CC,MM,M")
call <SID>AddAlternateExtensionMapping('hxx',"cpp,c,cxx,cc,mm,m")
call <SID>AddAlternateExtensionMapping('HXX',"CPP,C,CXX,CC,MM,M")
call <SID>AddAlternateExtensionMapping('hh',"cpp,c,cxx,cc,mm,m")
call <SID>AddAlternateExtensionMapping('HH',"CPP,C,CXX,CC,MM,M")
call <SID>AddAlternateExtensionMapping('c',"h")
call <SID>AddAlternateExtensionMapping('C',"H")
call <SID>AddAlternateExtensionMapping('cpp',"h,hpp,hxx,hh")
call <SID>AddAlternateExtensionMapping('CPP',"H,HPP,HXX,HH")
call <SID>AddAlternateExtensionMapping('cc',"h,hpp,hxx,hh")
call <SID>AddAlternateExtensionMapping('CC',"H,h,HPP,HXX,HH")
call <SID>AddAlternateExtensionMapping('cxx',"h,hpp,hxx")
call <SID>AddAlternateExtensionMapping('CXX',"H,HPP,HXX")
" Mappings for PSL7
